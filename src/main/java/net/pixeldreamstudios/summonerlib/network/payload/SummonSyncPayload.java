...
public record SummonSyncPayload(UUID entityUuid, String summonType, boolean isRegistering) implements CustomPayload {

    public static final Id<SummonSyncPayload> ID = new Id<>(Identifier.of(SummonerLib.MOD_ID, "summon_sync"));
    ...
    public static final PacketCodec<RegistryByteBuf, SummonSyncPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.STRING, SummonSyncPayload::summonType,
